...
\section{Data Analysis Script}\label{appendix:data_analysis_script}
...
The script requires input CSV files containing stress-relaxation test data with specific column headers. It processes multiple strain levels (5\%, 10\%, 20\%) and generates both graphical and numerical outputs. The analyzed data is automatically saved to Excel files for further processing.