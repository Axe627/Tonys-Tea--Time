...
\begin{figure}[H]
    ...
    \label{fig:ch2_hybridhydrogel}\end{figure}
...
\begin{table}[H]
\centering
\caption[PCL Material Properties.]{\textbf{PCL Material Properties.} Comprehensive overview of polycaprolactone (PCL) material properties relevant to scaffold design and fabrication, including mechanical, thermal, and biological characteristics. Values and data compiled from: Woodruff \& Hutmacher (2010), Pitt et al. (1981), and Gunatillake \& Adhikari (2003).}
\label{tab:PCL-properties}
\renewcommand{\arraystretch}{1.3}
\setlength{\tabcolsep}{12pt}
\begin{tabular}{|p{4.5cm}|p{4cm}|p{5.5cm}|}
\hline
\textbf{Property} & \textbf{Value} & \textbf{Notes} \\[0.3em]
\hline
...
\hline
Crystallinity & 45--65\% & Semi-crystalline \\[0.3em]
\hline
Young's modulus & 300--400 MPa & Depends on MW and crystallinity \\[0.3em]
\hline
Tensile strength & 10--25 MPa & -- \\[0.3em]
\hline
Elongation at break & 300--500\% & Highly ductile \\[0.3em]
\hline
Flexural modulus & $\sim$400 MPa & -- \\[0.3em]
\hline
Decomposition temperature & $\sim$350$^\circ$C & Thermal degradation limit \\[0.3em]
\hline
Biodegradability & Months to years & Hydrolytic ester cleavage \\[0.3em]
\hline
Biocompatibility & Excellent & Used in FDA-approved medical devices \\[0.3em]
\hline
...
\begin{figure}[H]
    ...
    \label{fig:chap2_biomaterials}\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:ch2_hydrogel}\end{figure}
...
\begin{table}[H]
\centering
\caption[Water Content Analysis]{\textbf{Water Content Analysis.} Measured water content across hydrogel formulations with varying crosslinker concentrations and volumes, highlighting the relationship between crosslinking parameters and hydration capacity.}
\label{tab:ch2_water_content}
\renewcommand{\arraystretch}{1.3}
\setlength{\tabcolsep}{12pt}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{GTA (\%)} & \textbf{Volume (mL)} & \textbf{Water Content (\%)} & \textbf{Notes} \\
\hline
0.5 & 1.0 & 92.3 ± 1.2 & Highest hydration \\
\hline
0.5 & 2.0 & 91.8 ± 0.8 & Consistent high hydration \\
\hline
1.0 & 1.0 & 88.5 ± 1.5 & Moderate crosslinking \\
\hline
1.0 & 2.0 & 87.9 ± 1.1 & Volume effect minimal \\
\hline
1.5 & 1.0 & 85.2 ± 1.8 & Increased crosslinking \\
\hline
1.5 & 2.0 & 84.7 ± 1.4 & Lower hydration \\
\hline
\end{tabular}\end{table}
...
\begin{figure}[H]
    ...
    \label{fig:ch2_watercontent}\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Chapter 2/chapter2_ES_sem.pdf}
    ...
    \label{fig:ch2_sem_analysis}\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ch2_early_prototype.png}
    ...
    \label{fig:ch2_early_prototype}\end{figure}
