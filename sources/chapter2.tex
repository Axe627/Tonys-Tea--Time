...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{figures/chapter 2/ch2_hybridhydrogel.png}
    \caption[Hybrid Hydrogel Concept]{\textbf{Hybrid Hydrogel Concept.} The hybrid hydrogel concept integrates natural and synthetic components to mimic native meniscal tissue. This composite system combines hydrated polymer networks with synthetic fiber reinforcements to achieve both biological functionality and mechanical robustness.}
    \label{fig:ch2_hybridhydrogel}
\end{figure}

\section{"Hybrid Hydrogel": \protect\\ Mechanical and Biological Targets}
...
\textbf{Structural Stability and Physiological Loading.} Maintenance of form under physiological loading conditions is essential for long-term scaffold performance~\cite{bilgen2018currentconcepts, ghodbane2019partialmeniscus}. The meniscus experiences complex loading patterns including compression, tension, and shear forces. Scaffolds must demonstrate sufficient structural integrity to resist deformation while maintaining biological functionality throughout healing.

Given these requirements, natural or composite natural--synthetic biomaterials offer a promising solution. The meniscus's organized fibrocartilaginous structure demands scaffolds that can replicate both mechanical and biological behavior. The integration of natural hydrogels with synthetic reinforcements provides a pathway to achieve these competing demands.

\textbf{Natural-Synthetic Material Integration Strategy.} Our approach leverages complementary properties of natural and synthetic biomaterials. Natural materials, specifically gelatin A (GelA) derived from porcine collagen, provide essential biological cues including cell-binding motifs and biocompatibility that support cellular function~\cite{ahmed2015hydrogelpreparation, zhang2005electrospinninggelatin}. These components maintain the hydrated environment while offering tunable properties through controlled crosslinking~\cite{ronca2023developmenthighly, osaki2018microphysiological3d,guarino2011hmscinteraction, ratner2013naturematter, chaudhuri2016hydrogelstunable}.

Synthetic materials like polycaprolactone (PCL) provide structural integrity through excellent mechanical properties, while offering predictable degradation and processing versatility~\cite{woodruff2010returnforgotten, gao2018electrospunfiber, field2021tuneablephotocurable}. The integration of PCL with natural hydrogels creates a hybrid system that maintains biological functionality while achieving necessary mechanical stability and water content (70-80\%) through synthetic reinforcement~\cite{elkommos2025hybridhydrogels}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/chapter 2/ch2_biomaterials.png}
...
\begin{table}[H]
    \centering
    \caption[PCL Material Properties.]{\textbf{PCL Material Properties.} Data adapted from Woodruff et al. \cite{woodruff2010returnforgotten} and Pitt et al. \cite{pitt1981aliphaticpolyesters}}
    \label{tab:PCL-properties}
    \setlength{\tabcolsep}{8pt}
    \begin{tabular}{|p{4.5cm}|p{4cm}|}
        \hline
        \cellcolor{gray!20}\textbf{Property} & \cellcolor{gray!20}\textbf{Value} \\[0.3em]
        \hline
...
The effect of concentration on hydrogel properties has been extensively studied in tissue engineering applications~\cite{buckley2009effectconcentration}, demonstrating that polymer concentration directly influences both mechanical behavior and biological functionality. Higher concentrations typically result in increased mechanical stiffness but may compromise cellular infiltration and nutrient diffusion. Understanding these concentration-dependent effects is crucial for optimizing hydrogel formulations for meniscal tissue engineering applications.

Microstructural modeling approaches have provided valuable insights into the relationship between hydrogel architecture and mechanical behavior~\cite{bursac2000microstructuralmodel}, revealing how network topology, crosslinking density, and polymer concentration interact to determine overall scaffold performance. These modeling frameworks help guide the design of hydrogels with specific mechanical and biological properties tailored for meniscal replacement applications.
...
The structural organization of polymeric networks plays a critical role in determining hydrogel performance~\cite{brand2001structuraloutline}. The arrangement of polymer chains, crosslinking density, and network topology all contribute to the overall mechanical and biological properties of the scaffold. Understanding these structural relationships is essential for designing hydrogels that can effectively mimic the complex mechanical behavior of native meniscal tissue.

\section{Gelatin-GTA Hydrogel Fabrication Overview} \label{sec:ch2_methods}
...
As shown in Figure~\ref{fig:ch2_hydrogel}, varying the volume and concentration of glutaraldehyde (GTA) solution produces a range of GelA--GTA molar ratios used for hydrogel crosslinking. Three GTA concentrations—0.5\%, 1.5\%, and 2.5\% (v/v)—were combined with volumes of 0.25 mL, 0.50 mL, and 1.00 mL to generate nine distinct conditions. These combinations result in GelA--GTA molar ratios of 15, 30, 60, 25, 50, 100, 75, 150, and 300 mol/mol, as indicated in the 9-well plate layout. Lower concentrations and smaller volumes yield lower crosslinking densities (e.g., 15 mol/mol at 0.25 mL of 0.5\% (v/v) GTA), while higher concentrations and volumes proportionally increase the crosslinking ratio (up to 15 mol/mol at 1.00 mL of 2.5\% (v/v) GTA). This design enables precise control over hydrogel network formation by systematically adjusting the total amount of crosslinker relative to gelatin.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/chapter 2/ch2_hydrogel.png}
...
The strain-dependent behavior of hydrogel swelling has been extensively characterized~\cite{chendepthstraindependent}, revealing how mechanical deformation can significantly alter the network structure and fluid transport characteristics. This understanding is particularly important for meniscal tissue engineering applications where the scaffold will experience complex loading conditions that can influence both mechanical performance and biological functionality.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{2.8cm}|p{2.8cm}|p{2.8cm}|p{2.8cm}|}
        \hline
        \cellcolor{gray!20}\textbf{Water Content (\%)} & \multicolumn{3}{c|}{\cellcolor{gray!20}\textbf{GTA Concentrations (v/v)}} \\[0.3em]
        \hline
        \cellcolor{gray!20}\textbf{Volume (mL)} & \cellcolor{gray!20}\textbf{2.5\% GTA} & \cellcolor{gray!20}\textbf{1.5\% GTA} & \cellcolor{gray!20}\textbf{0.5\% GTA} \\[0.3em]
        \hline
        \cellcolor{gray!20}1.00 & 59.48 $\pm$ 4.54 & 67.54 $\pm$ 11.82 & 72.65 $\pm$ 9.71 \\[0.3em]
        \hline
        \cellcolor{gray!20}0.50 & 64.48 ± 4.07 & 77.49 ± 5.46 & 77.94 ± 4.93 \\[0.3em]
        \hline
        \cellcolor{gray!20}0.25 & 80.85 ± 5.63 & 75.62 ± 5.49 & 83.48 ± 5.99 \\[0.3em]
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{figures/chapter 2/ch2_watercontent.png}
...
SEM analysis confirmed the formation of randomly oriented fibers, successfully mimicking the superficial meniscal layer's disorganized collagen architecture. Fiber diameter was observed to increase with higher extrusion rates, consistent with prior findings~\cite{schneider2018codepositionhydrogel, park2003biomaterialsprinciples,rahmati2021electrospinningtissue,zhang2005electrospinninggelatin}. Although the hybrid co-deposition technique was developed to improve mechanical integrity and porosity, further mechanical and permeability testing is required to validate its effectiveness.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.96\textwidth]{figures/chapter 2/ch2_ES_sem.png}
    \caption[Co-Deposition Electrospinning: Setup and Fiber Characterization]{\textbf{Co-Deposition Electrospinning: Setup and Fiber Characterization.} Top row: Custom vertical electrospinning apparatus developed for controlled fiber deposition, followed by PCL network placement during co-deposition after initial gelatin layer formation, continued electrospinning over PCL network for composite integration, and final co-deposited PCL-gelatin construct following GTA crosslinking. Bottom row: SEM analysis showing electrospun GelA fiber distribution and organization (left, scale bar: 50~$\mu$m) and detailed view of individual fiber dimensions and morphology (right, scale bar: 20~$\mu$m).}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{4.5cm}|p{6.8cm}|}
        \hline
        \cellcolor{gray!20}\textbf{Parameter} & \cellcolor{gray!20}\textbf{Value / Description} \\
        \hline
...
Initial HANI platform development combined PCL reinforcement structures with gelatin-based hydrogels to create composite scaffolds matching native meniscal tissue properties. PCL grids were fabricated via FDM and integrated into GelA-GTA hydrogels during crosslinking. Early mechanical testing challenges led to development of an enhanced compression testing system. Further details on manufacturing and testing methods are presented in later chapters.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{figures/chapter 2/ch2_earlyHANI.png}
    \caption[Early HANI Scaffold Prototype.]{\textbf{Early HANI Scaffold Prototype.} Early composite HANI scaffolds featuring University of Miami ``U'' logo (top left), initial lattice structure under compression (top middle), and radial pattern demonstrating PCL network integration (top right). Bottom panels show SEM images of PCL gyroid networks highlighting controlled fiber diameter and spacing (left) and PCL surface morphology (right). Scale bars: 500~$\mu$m.}
...
Initial characterization revealed significant limitations in conventional mechanical testing approaches for hydrated constructs, with traditional confined compression setups proving inadequate for capturing complex poroviscoelastic behavior. To address challenges with force sensitivity, hydration maintenance, and alignment, Chapter 3 introduces custom-designed mechanical testing equipment developed through additive manufacturing techniques to enable more precise property measurements under physiologically relevant conditions.

The fundamental distinction between confined and unconfined compression testing provides complementary insights for characterizing hydrated biomaterials~\cite{bursaconnedunconned,carterindepthguide}. While confined testing simulates constrained in vivo conditions, unconfined testing allows free radial deformation - both approaches are essential for fully understanding the mechanical response of these materials, as detailed in subsequent chapters on mechanical characterization methodology.
