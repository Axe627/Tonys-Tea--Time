...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/chapter 3/ch3_iterations.pdf}
...
\section{Development of an \protect\\ Additively Manufactured Permeation Chamber}
