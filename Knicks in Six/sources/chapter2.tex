...
\begin{table}[htbp]
\centering
\caption{Material Properties of Polycaprolactone (PCL)}
\begin{tabular}{|p{5cm}|p{4.5cm}|p{5cm}|}
\hline
\textbf{Property} & \textbf{Value (Typical)} & \textbf{Notes / References} \\
\hline
Chemical formula & (C$_6$H$_{10}$O$_2$)$_n$ & Aliphatic polyester \\
\hline
Molar mass (monomer) & 114.14 g/mol & -- \\
\hline
Density & 1.145--1.150 g/cm$^3$ & \cite{woodruff2010returnforgotten, pitt1981polycaprolactone} \\
\hline
Melting point & 58--63$^\circ$C & \cite{pitt1981polycaprolactone} \\
\hline
Glass transition temperature (Tg) & --60$^\circ$C & \cite{woodruff2010returnforgotten} \\
\hline
Crystallinity & 45--65\% & Semi-crystalline \cite{gunatillake2003polycaprolactone} \\
\hline
Young's modulus & 300--400 MPa & Depends on MW and crystallinity \cite{woodruff2010returnforgotten} \\
\hline
Tensile strength & 10--25 MPa & \cite{woodruff2010returnforgotten} \\
\hline
Elongation at break & 300--500\% & Highly ductile \cite{woodruff2010returnforgotten} \\
\hline
Flexural modulus & $\sim$400 MPa & -- \\
\hline
Hardness (Shore D) & $\sim$55 & Relatively soft \\
\hline
Print temperature (FDM) & 80--120$^\circ$C & Low-temperature thermoplastic \\
\hline
Decomposition temperature & $\sim$350$^\circ$C & Thermal degradation limit \\
\hline
Biodegradability & Months to years & Hydrolytic ester cleavage \cite{gunatillake2003polycaprolactone} \\
\hline
Biocompatibility & Excellent & Used in FDA-approved medical devices \cite{woodruff2010returnforgotten} \\
\hline
Degradation byproduct & Caproic acid & Non-toxic \\
\hline
\end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/Chapter 2/chapter2_biomaterials.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Chapter 2/chapter2_hydrogel.pdf}
...
\begin{table}[H]
\centering
\caption{Measured Water Content (\(\phi_{WC}\)) Across Hydrogel Formulations}
\label{tab:ch2_water_content}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Volume (mL)} & \textbf{0.5\% GTA} & \textbf{1.5\% GTA} & \textbf{2.5\% GTA} \\ \hline
0.25 & 83.48\% $\pm$ 5.99\% & 75.62\% $\pm$ 5.49\% & 80.85\% $\pm$ 5.63\% \\ \hline
0.50 & 77.94\% $\pm$ 4.93\% & 77.49\% $\pm$ 5.46\% & 64.48\% $\pm$ 4.07\% \\ \hline
1.00 & 72.65\% $\pm$ 9.71\% & 70.55\% $\pm$ 6.58\% & 59.48\% $\pm$ 4.54\% \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Summary of Electrospinning Parameters for Gelatin Fiber Fabrication}
\label{tab:electrospinning_params}
\begin{tabular}{|p{5cm}|p{7cm}|}
\hline
\textbf{Parameter} & \textbf{Value / Description} \\ \hline
Polymer Solution & 10\% w/v Gelatin A in HFIP \\ \hline
Solvent & Hexafluoroisopropanol (HFIP) \\ \hline
Syringe & 10~mL Luer-lock \\ \hline
Dispensing Needle & 23G tip \\ \hline
Voltage & 21~kV \\ \hline
Flow Rate & 2 and 3~mL/hr \\ \hline
Needle-Collector Distance & 15~cm \\ \hline
Collector Type & Vertical aluminum block with foil \\ \hline
Crosslinking Agent & 2.5\% Glutaraldehyde (30~min) \\ \hline
Post-Treatment & Glycine rinse + DI water wash \\ \hline
Fiber Analysis & SEM imaging + diameter measurement \\ \hline
Co-Deposition Method & Initial 2~mL gelatin electrospun; PCL grid placed; remainder electrospun over \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \caption{Placeholder for SEM images showcasing: (A) native GelA hydrogel microstructure; (B) electrospun gelatin fibers; (C) PCL grid structure; (D) hybrid co-deposited composite. Final images will highlight fiber morphology, pore distribution, and integration features.}
